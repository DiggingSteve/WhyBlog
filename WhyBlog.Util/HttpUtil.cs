...
namespace WhyBlog.Util
{
    public static class HttpUtil
    {
        ...
        public static async Task<string> HttpGetAsync(string url, Encoding encoding = null)
        {
            ...
            httpClient.DefaultRequestHeaders.Add("User-Agent", "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.84 Safari/537.36");
